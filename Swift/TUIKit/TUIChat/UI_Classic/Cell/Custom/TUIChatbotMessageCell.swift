...
public class TUIChatbotMessageCell: TUITextMessageCell {
    ...
    public func immediateStopRendering() {
        ...
        print("TUIChatbotMessageCell: Immediate stop rendering executed")
    }
