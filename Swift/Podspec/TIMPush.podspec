Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.qcloud.com/download/tuiplugin/9.0.7652/ios/TIMPush_9.0.7652.xcframework.zip'}
  
  spec.dependency 'TXIMSDK_Plus_iOS_XCFramework','>= 9.0.7652'
