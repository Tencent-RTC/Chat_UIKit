Pod::Spec.new do |spec|
  ...
  spec.source = { :http => 'https://im.sdk.cloud.tencent.cn/download/tuikit/8.9.7511/ios/TUIVoiceToTextPlugin_Swift.zip'}
  ...
  spec.subspec 'CommonModel' do |commonModel|
    ...
    commonModel.dependency 'TUIChat_Swift', '~> 8.9.7511'
  end
